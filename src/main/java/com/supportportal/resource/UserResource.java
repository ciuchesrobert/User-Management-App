...
public class UserResource extends ExceptionHandling {
    ...
    public static final String EMAIL_SENT = "An email with th new password was sent to: ";
    ...
    public ResponseEntity<User> register(@RequestBody User user) throws UsernameNotFountException, UsernameExistsException, MessagingException {
